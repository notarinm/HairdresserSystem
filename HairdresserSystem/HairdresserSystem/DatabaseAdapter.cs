...
namespace HairdresserSystem
{
    public class DatabaseAdapter
    {
        ...
        // =====================================================
        public List<(int id, DateTime start, DateTime end, string masterName, string clientName, string service, string workplace, string status)>
    GetGeneralSchedule(DateTime date)
        {
            var schedule = new List<(int, DateTime, DateTime, string, string, string, string, string)>();
                    ...
                    using (var reader = cmd.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            schedule.Add((
                                ...
                                reader.GetDateTime(1),  // start
                                reader.GetDateTime(2),  // end
                                reader.GetString(3),    // masterName
                                reader.GetString(4),    // clientName
                                reader.GetString(5),    // service
                                reader.GetString(6),    // workplace
